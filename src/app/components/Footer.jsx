                ...
                <div className="hidden md:grid grid-cols-3 gap-20 items-start text-left">
                    ...
                    >
                        ...
                        <p className="font-sans">
                            ✉️ <a href="mailto:Retreats@akhandayoga.com" className="underline hover:text-[#f4b400]">Retreats@akhandayoga.com</a>
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#contact" className="hover:text-[#f4b400] text-gtwalsheim">Contact</a></li>
