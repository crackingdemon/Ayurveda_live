  ...
  return (
    <section className="min-h-screen w-full bg-[#fcf8ed] flex items-center justify-center text-white py-8">
      ...
      >
        ...
        {/* First Paragraph */}
        <p className="text-gtwalsheim text-[#031059] font-light leading-relaxed   max-w-8xl text-base sm:text-lg md:text-xl lg:text-xl xl:text-[1.5vw]  mb-10">
        ...
        {/* Second Paragraph */}
        <p className="text-gtwalsheim text-[#031059] font-light leading-relaxed  max-w-8xl text-base sm:text-lg md:text-xl lg:text-xl xl:text-[1.5vw] ">
        ...
        {/* Footer Line */}
        <p className="text-gtwalsheim text-[#031059] font-medium text-center text-lg sm:text-xl md:text-2xl max-w-8xl lg:text-2xl xl:text-[1.7vw] leading-relaxed">
