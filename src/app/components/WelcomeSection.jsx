...
export default function WelcomeSection() {
  ...
  return (
    <section className="min-h-screen w-full bg-[#fcf8ed] flex items-center justify-center text-white py-8">
      ...
      >
        {/* Title */}
        <h1 className="text-Black-Mango-ExtraBold text-[#031059] text-3xl sm:text-5xl md:text-6xl xl:text-[4vw] font-light mb-10 tracking-tight leading-tight">
          A Return to the Science of Life
        </h1>

        {/* First Paragraph */}
        <p className="text-gtwalsheim text-[#031059] font-light leading-relaxed  text- max-w-5xl text-base sm:text-lg md:text-xl lg:text-xl xl:text-[1.5vw]  mb-10">
        ...
        {/* Second Paragraph */}
        <p className="text-gtwalsheim text-[#031059] font-light leading-relaxed  text- max-w-5xl text-base sm:text-lg md:text-xl lg:text-xl xl:text-[1.5vw] ">
        ...
        {/* Bullet Points */}
        <ul className="text-gtwalsheim text-[#031059] font-light text-base sm:text-lg md:text-xl lg:text-xl xl:text-[1.5vw] mb-10 space-y-1">
        ...
        {/* Footer Line */}
        <p className="text-gtwalsheim text-[#031059] font-medium text-center text-lg sm:text-xl md:text-2xl max-w-6xl lg:text-2xl xl:text-[1.7vw] leading-relaxed">
