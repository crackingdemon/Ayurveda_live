  ...
  return (
    <section className="min-h-screen w-full bg-[#7f844d] flex items-center justify-center text-white py-12 px-4 sm:px-8 md:px-16 lg:px-24">
      ...
      >
        ...
        <p className="text-white font-light leading-relaxed max-w-4xl text-base sm:text-lg md:text-xl">
        ...
        <h2 className="text-white font-semibold text-xl sm:text-2xl md:text-2xl">
          Key principles include:
        </h2>

        {/* Key Bullet Points */}
        <div className="text-white font-light text-base sm:text-lg md:text-xl leading-relaxed space-y-2 max-w-4xl">
          <p>
